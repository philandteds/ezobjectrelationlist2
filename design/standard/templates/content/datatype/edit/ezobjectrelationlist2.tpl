...
{else}    {* Standard mode is browsing *}
    ...
    {* Simple interface. *}
    {else}
        {def $c_class = fetch( 'content', 'class', hash( 'class_id', $attribute.contentclass_attribute.contentclass_id ) )}
        ...
        <tr>
            ...
            {if ezini_hasvariable( concat( 'RelationAttributes_', $c_class.identifier ), $attribute.contentclass_attribute_identifier, 'ezobjectrelationlist2.ini' )}
                ...
                <th class="tight">{$name|i18n( 'design/standard/content/datatype' )}</th>
                {/foreach}
            {/if}
        </tr>
        </thead>
        ...
        {include uri='design:content/datatype/edit/ezobjectrelation2_ajax_search.tpl'}
	{/if}
